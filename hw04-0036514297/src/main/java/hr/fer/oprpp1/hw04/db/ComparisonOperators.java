...
public class ComparisonOperators {
	...
	public static final IComparisonOperator EQUALS = (l1, l2) -> l1.equals(l2);
	public static final IComparisonOperator NOT_EQUALS = (l1, l2) -> !EQUALS.satisfied(l1, l2);
	public static final IComparisonOperator LIKE = (l1, l2) -> l1.matches(l2.replaceFirst("[*]", "[a-zA-Z0-9čćšđž]*"));
